...
<section id="404" class="page hidden">
            <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50 py-12 px-4">
                <div class="max-w-lg w-full text-center">
                    ...
                    <p class="text-gray-600 mb-8 text-lg">The page you're looking for seems to have been misplaced in the library stacks. Don't worry, let's find your way back.</p>
                    <div class="space-x-4">
                        <a href="#home" class="inline-block bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition duration-300">
                            <i class="fas fa-home mr-2"></i> Back to Home
                        </a>
                        <a href="#books" class="inline-block bg-gray-200 text-gray-800 px-6 py-3 rounded-lg font-semibold hover:bg-gray-300 transition duration-300">
